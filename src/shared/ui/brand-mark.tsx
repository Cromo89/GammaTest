      ...
      <svg width="30" height="30" viewBox="0 0 84 84" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0">
        <g clipPath="url(#brand-mark-clip)">
          <path
            ...
            fill="url(#brand-mark-gradient-1)"
          />
          <path
            ...
            fill="url(#brand-mark-gradient-2)"
          />
          <path
        ...
        <defs>
          <linearGradient id="brand-mark-gradient-1" x1="92.5" y1="32" x2="14.1548" y2="78.345" gradientUnits="userSpaceOnUse">
            <stop stopColor="#0666D8" />
            <stop offset="0.446232" stopColor="#0A84FF" />
            <stop offset="1" stopColor="#10D7C4" />
          </linearGradient>
          <linearGradient id="brand-mark-gradient-2" x1="8.24881" y1="90.4063" x2="41.4466" y2="4.25975" gradientUnits="userSpaceOnUse">
